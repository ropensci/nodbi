...
## Deprecated
  * Parameter `query` should be a valid JSON string and now triggers a warning if empty; change `query = ""` into `query = "{}"` 
...
* adapted to use new `JSONB` functions in `SQLite` 3.45.0 (`RSQLite` >= 2.3.4.9005)
