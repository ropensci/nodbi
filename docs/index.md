...
`# 2026-08-23`` `[`options`](https://rdrr.io/r/base/options.html)`(``duckdb.home ``=`` ``"~/.duckdb"``)`` `[`suppressMessages`](https://rdrr.io/r/base/message.html)`(``testthat``::`[`test_local`](https://testthat.r-lib.org/reference/test_package.html)`(``)``)`` ``# ✔ | F W S OK | Context`` ``# ✔ | 2 184 | couchdb [77.7s]`` ``# ✔ | 1 183 | duckdb [3.6s]`` ``# ✔ | 2 181 | elastic [65.3s]`` ``# ✔ | 2 181 | mariadb-remote [17.2s]`` ``# ✔ | 2 181 | mariadb [6.6s]`` ``# ✔ | 2 182 | mongodb [4.6s]`` ``# ✔ | 185 | postgres [7.2s]`` ``# ✔ | 186 | sqlite [4.2s]`` ``# `` ``# ══ Results ═══════════════════════════════`` ``# Duration: 186.3 s`` ``# `` ``# ── Skipped tests (11) ────────────────────`` ``# • empty test (2): test-mariadb-remote.R:27:3, test-mariadb.R:22:3`` ``# • Testing for auto disconnect and shutdown not relevant (5): `` ``# test-couchdb.R:26:3, test-elastic.R:21:3,`` ``# test-mariadb-remote.R:27:3, test-mariadb.R:22:3, test-mongodb.R:24:3`` ``# • Testing for parallel writes not possible or implemented (4): `` ``# test-couchdb.R:26:3, test-duckdb.R:22:3,`` ``# test-elastic.R:21:3, test-mongodb.R:24:3`` ``# `` ``# [ FAIL 0 | WARN 0 | SKIP 11 | PASS 1463 ]`` `` ``covr``::`[`package_coverage`](http://covr.r-lib.org/reference/package_coverage.md)`(``path ``=`` ``"."``, type ``=`` ``"tests"``)`` ``# nodbi Coverage: 94.72%`` ``# R/src_postgres.R: 82.43%`` ``# R/src_duckdb.R: 84.00%`` ``# R/zzz.R: 86.67%`` ``# R/src_mariadb.R: 92.86%`` ``# R/src_mongo.R: 95.00%`` ``# R/query.R: 95.28%`` ``# R/update.R: 95.40%`` ``# R/get.R: 96.19%`` ``# R/create.R: 96.62%`` ``# R/delete.R: 99.02%`` ``# R/exists.R: 100.00%`` ``# R/list.R: 100.00%`` ``# R/src_couchdb.R: 100.00%`` ``# R/src_elastic.R: 100.00%`` ``# R/src_sqlite.R: 100.00%`
