...
`nodbi` is an R package that provides a single interface for several NoSQL databases and databases with JSON functionality, with the same function parameters and return values across all database backends. Last updated 2026-01-17.
...
As of 2026-01-17, the future availability and development of package elastic is not clear after it was recently archived, see also <https://github.com/ropensci-archive/elastic>; at this time, it can still be installed as follows. 
