...
across all database backends. \*Only simple queries (and updates, e.g. equality for a single field) supported for Elasticsearch at the moment. \*\*Only root fields can be specified for CouchDB and Elasticsearch, whereas subitems in fields can be specified for MongoDB and SQLite.
