...
| Update (patch) selected documents with new data in data frame, list, JSON string, a file name or url pointing to NDJSON records `my_data` | `nodbi::docdb_update(src = src, key = "my_container", value = my_data, query = '{"age": 20}')` |
