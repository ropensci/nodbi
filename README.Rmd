...
`nodbi` is an R package that provides a single interface for several NoSQL databases and databases with JSON functionality, with the same function parameters and return values across all database backends. Last updated 2023-12-31.
...
# 2024-01-04 with 2015 mobile hardware, databases via homebrew
...
testthat::test_local()
# ✔ | F W  S  OK | Context
# ✔ |      2 151 | couchdb [123.0s]                                                   
# ✔ |      1 150 | duckdb [6.1s]                                                      
# ✔ |      2 149 | elastic [106.6s]                                                   
# ✔ |      2 149 | mongodb [6.5s]                                                     
# ✔ |        151 | postgres [49.6s]                                                   
# ✔ |        153 | sqlite [44.7s]                                                     
# 
