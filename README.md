...
result <- rbenchmark::benchmark(
  ...
  MariaDB = testFunction(src = srcMariadb),
...
pkgs <- c("nodbi", "RSQLite", "duckdb", "RPostgres", "mongolite", "elastic", "sofa", "RMariaDB")
...
# 
# ── Skipped tests (9) ──────────────────────────────────────────
# • empty test (1): test-mariadb.R:22:3
# • Testing for auto disconnect and shutdown not relevant (4): 
#   test-couchdb.R:26:3, test-elastic.R:21:3,
#   test-mariadb.R:22:3, test-mongodb.R:24:3
...
# 
# [ FAIL 0 | WARN 4 | SKIP 9 | PASS 1281 ]
