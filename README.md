...
<https://duckdb.org/docs/extensions/json>. “Container” refers to a
DuckDB table.
...
See [JSON1](https://www.sqlite.org/json1.html), available in RSQLite.
...
for container names (parameter `key`). Opensearch can equally be used.
